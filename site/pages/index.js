...
export default function Home({ searchText }) {
  ...
  return (
    <div className="">
      ...
      <h1 className='flex uppercase tracking-widest justify-center mb-10'><span className='flex items-center text-lg bg-slate-100/90 rounded overflow-hidden shadow'><span className='flex px-3 text-xs opacity-100'>Workspaces</span> <span className='text-white p-3 py-1 flex bg-[#a3be8c]'>{workspaces && workspaces.workspacecount}</span></span></h1>
