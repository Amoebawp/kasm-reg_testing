...
function Workspace({ Component, pageProps, workspace }) {
    ...
    return (
        <div onClick={() => viewexample(workspace)} className="w-[245px] h-[88px] transition-all relative cursor-pointer group flex p-2 items-center justify-center bg-slate-100/90 shadow rounded hover:shadow-xl hover:bg-gradient-to-r hover:from-[#a3be8c] hover:to-[#8fbcbb] hover:text-[#e5e9f0]">
