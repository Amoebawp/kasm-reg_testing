...
export default function Header({ searchText, changeSearch }) {
  ...
  return (
    <header className="relative font-light overflow-hidden bg-gradient-to-tr from-[#b48ead] to-[#a3be8c] p-8 xl:px-32 text-[#e5e9f0] gap-5 md:gap-0 flex flex-wrap justify-center items-center">
      <Bubbles />
